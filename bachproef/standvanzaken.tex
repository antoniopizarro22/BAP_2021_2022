...
Een continuous deployment (CD) pipeline kan worden opgezet via Copilot.
Copilot is compatibel met de volgende git repositories: GitHub, BitBucket en CodeCommit.
Wanneer een push wordt gedetecteerd, de pipeline bouwt de service, bewaart de container image op ECR en begint de deploy naar een omgeving~\autocite{Karakus2022}.
