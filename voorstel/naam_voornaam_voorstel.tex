...
\PaperTitle{Infrastructure as Code}
\PaperType{Onderzoeksvoorstel Bachelorproef 2019-2020} % Type document

% TODO: vul je eigen naam in als auteur, geef ook je emailadres mee!
\Authors{Antonio Pizarro\textsuperscript{1}} % Authors
\CoPromotor{Herman van der Merwe\textsuperscript{2} (Wolters Kluwer)}
\affiliation{\textbf{Contact:}
  \textsuperscript{1} \href{mailto:antonio.pizarro@student.hogent.be}{antonio.pizarro@student.hogent.be};
  \textsuperscript{2} \href{mailto:Herman.Merwe@wolterskluwer.com}{Herman.Merwe@wolterskluwer.com};
}
...
\Keywords{Infrastructure as Code Migration --- DevOps --- Cloud} % Keywords
